...
def main(
    ...
    DH_Regions, hdm_dh_region_cut, geo_transform, total_heat_demand = DHP.DHReg(
        heat_density_map, pix_threshold, DH_threshold, in_orig
    )
    ...
    if dh_area_flag:
        ...
        symbol_vals_str = polygonize(
            output_raster1, temp_raster, output_shp1, output_shp2, DHPot
        )
