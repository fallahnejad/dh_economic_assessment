...
if __name__ == "__main__":
    ...
    scenario_input_csv = output_directory + "/cm_input_ms.csv"
    d = pd.read_csv(scenario_input_csv, index_col=0, header=0, squeeze=True).T.to_dict()
    ...
    Parallel(n_jobs=nr_cores)(
        delayed(res_calculation)(key, country_path_dict[key], d[key])
